...
export const en = {
  ...
  booking: {
    ...
    confirm: {
      title: "Request sent!",
      body: "Your custom design request has been sent to our studio. We will review your references and details, then contact you shortly to confirm.",
  ...
  appointment: {
    ...
    page: {
      ...
      confirm: {
        title: "Request sent!",
        body: "Your appointment request has been sent to our studio. We will review your details and contact you shortly to confirm the date and time.",
        responseLabel: "Estimated response time",
        responseTime: "Within 2–6 hours during business hours (9 AM – 9 PM).",
        copyDetails: "Copy details",
      },
